...
function Footer() {
  return (
    <div className=' flex w-full h-screen bg-zinc-900'>
        <div className='footer-text font-semibold tracking-tighter w-1/2 h-full flex flex-col justify-between px-16 py-24'>
            <div className=''>
                <h1 className='text-[7vw] leading-none '>EYE-</h1>
                <h1 className='text-[7vw] leading-none'>OPENING</h1>
            </div>
            <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg" className='-mb-12' >
        ...
        <h1 className='footer-text font-semibold tracking-tighter text-[7vw] leading-none'>PRESENTATIONS</h1>
        <div className='dets'>
            <p className='mt-12 mb-6 text-lg'>S:</p>
            {["Instagram", "Behance", "Facebook", "Linkedin"].map((item,index)=>{
                return(
                    <a href='#' className='block text-lg'>{item}</a>
                )
            })}
            <div className='w-full flex items-center justify-between'>
                <div>
                <p className='mt-10 mb-6 text-lg' >L:</p>
                {["202-1965 W 4th Ave", "Vancouver,Canada", "30 Chukarina St", "Lviv,Ukraine"].map((item,index)=>{
                    return(
                        <h3 className='block text-lg'>{item}</h3>
                    )
                })}
                </div>
            ...
            {["Home", "Services", "Our Work", "About us", "Insights", "Contact us"].map((item,index)=>{
                return(
                    <a href='#' className='block mr-20 text-lg'>{item}</a>
                )
            })}
            </div>
            </div>
            <p className='mt-10 mb-3 text-lg'>E:</p>
